...
def test_apps_download(mocker):
    ...
    html = download('https://casas.mitula.com.co/searchRE/nivel3-Chapinero'
                    + '/nivel2-Bogot%C3%A1/nivel1-Cundinamarca/tipo-Casa'
...
def test_apps_get_url():
    assert get_url() == 'https://casas.mitula.com.co/searchRE/'\
                        + 'nivel3-Chapinero/nivel2-Bogot%C3%A1/nivel1'\
                        + '-Cundinamarca/tipo-Casa/q-Bogot%C3%A1-Chapinero'
